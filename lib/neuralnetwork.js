//this file depends on underscore.js
//this file depends on lookup.js
...
NeuralNetwork.prototype = {
  ...
  runInput: function(input) {
    this.layers[0] = input;  // set output state of input layer & ***RENAME OUTPUTS TO LAYERS
    ...
    for (var layer = 1; layer <= this.outputLayer; layer++) {
      for (var node = 0; node < this.sizes[layer]; node++) {
        ...
        this.layers[layer][node] = 1 / (1 + Math.exp(-sum));
      }
    }
    return this.layers[this.outputLayer];
  },
